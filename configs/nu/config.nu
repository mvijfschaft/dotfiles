...
$env.config = {
    ...
    buffer_editor: helix # command that will be used to edit the current line buffer with ctrl+o, if unset fallback to $env.VISUAL and $env.EDITOR
...
source C:\Users\mvijf\Repos\dotfiles\configs\nu\modules\mod.nu